...
var supportedModes = {
    ...
    RuntimePerl: ["runtimeperl"],
    RuntimeGroovy: ["runtimegroovy"],
    RuntimeRuby: ["runtimeruby"],
    RuntimeBatchFile: ["runtimebatchfile"],
    RuntimeJavaRegex: ["runtimejavaregex"],
    RuntimeJavaHexRegex: ["runtimejavahexregex"],
    RDGroovy:	 ["rdgroovy"],
    ABAP:        ["abap"],
    ABC:         ["abc"],
    ActionScript:["as"],
