var pullJsonElement = {
    template:
        ...
        "   <span class='nodeDescription'>Pull JSON</span>" +
        "	<button class='nodeShowHide icon-minus'></button>" +
        "	<button class='nodeDelete icon-cross'></button>" +
	    "	<div class='nodeContent'>" +
	    "		<span class='nodeTitle' contenteditable='true'>Pull JSON</span>" + 
	    "		<br>" + 
    ...
    initialize: function() {
        ...
        nodePanel.setupPullJsonDataPanel(connectionURL, connectionTypeURL);
