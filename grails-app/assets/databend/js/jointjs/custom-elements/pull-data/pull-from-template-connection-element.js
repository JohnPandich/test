var pullFromTemplateConnectionElement = {
    template:
        "<div class='node'><div class='nodeEdge'>" +
        "   <span class='nodeDescription'>Pull From Template (Connection)</span>" +
        "	<button class='nodeShowHide icon-minus'></button>" +
        "	<button class='nodeDelete icon-cross'></button>" +
	    "	<div class='nodeContent'>" +
	    "		<span class='nodeTitle' contenteditable='true'>Pull From Template (Connection)</span>" + 
	    "		<br>" + 
    ...
    initialize: function() {
        ...
        var connectionTypeURL = this.model.prop("connectionTypeURL");
        ...
        nodePanel.setupPullTemplateConnectionPanel(connectionURL, connectionTypeURL);
