var pullXmlElement = {
    template:
        ...
        "   <span class='nodeDescription'>Pull XML</span>" +
        "	<button class='nodeShowHide icon-minus'></button>" +
        "	<button class='nodeDelete icon-cross'></button>" +
	    "	<div class='nodeContent'>" +
	    "		<span class='nodeTitle' contenteditable='true'>Pull XML</span>" + 
	    "		<br>" + 
    ...
    initialize: function() {
        ...
        nodePanel.setupPullXmlDataPanel(connectionURL, connectionTypeURL);
