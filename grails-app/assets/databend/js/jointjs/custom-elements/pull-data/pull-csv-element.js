var pullCsvElement = {
    template:
        ...
        "   <span class='nodeDescription'>Pull CSV</span>" +
        "	<button class='nodeShowHide icon-minus'></button>" +
        "	<button class='nodeDelete icon-cross'></button>" +
	    "	<div class='nodeContent'>" +
	    "		<span class='nodeTitle' contenteditable='true'>Pull CSV</span>" + 
	    "		<br>" + 
    ...
    initialize: function() {
        ...
        nodePanel.setupPullCsvDataPanel(connectionURL, connectionTypeURL);
