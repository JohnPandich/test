var pullFromTemplateVariableElement = {
    template:
        "<div class='node'><div class='nodeEdge'>" +
        "   <span class='nodeDescription'>Pull From Template (Data Pool)</span>" +
        "	<button class='nodeShowHide icon-minus'></button>" +
        "	<button class='nodeDelete icon-cross'></button>" +
	    "	<div class='nodeContent'>" +
	    "		<span class='nodeTitle' contenteditable='true'>Pull From Template (Data Pool)</span>" + 
	    "		<br>" + 
    ...
    initialize: function() {
        ...
        var dataPoolURL = this.model.prop("dataPoolURL");
        ...
        nodePanel.setupPullTemplateVariablePanel(dataPoolURL);
