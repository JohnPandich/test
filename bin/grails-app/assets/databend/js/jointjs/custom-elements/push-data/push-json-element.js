var pushJsonElement = {
    template:
        ...
        "   <span class='nodeDescription'>Push JSON</span>" +
        "	<button class='nodeShowHide icon-minus'></button>" +
        "	<button class='nodeDelete icon-cross'></button>" +
	    "	<div class='nodeContent'>" +
	    "		<span class='nodeTitle' contenteditable='true'>Push JSON</span>" + 
	    "		<br>" + 
    ...
    initialize: function() {
        ...
        nodePanel.setupPushJsonDataPanel(connectionURL, connectionTypeURL);
