var pushCsvElement = {
    template:
        ...
        "   <span class='nodeDescription'>Push CSV</span>" +
        "	<button class='nodeShowHide icon-minus'></button>" +
        "	<button class='nodeDelete icon-cross'></button>" +
	    "	<div class='nodeContent'>" +
	    "		<span class='nodeTitle' contenteditable='true'>Push CSV</span>" + 
	    "		<br>" + 
    ...
    initialize: function() {
        ...
        nodePanel.setupPushCsvDataPanel(connectionURL, connectionTypeURL);
