var pushXmlElement = {
    template:
        ...
        "   <span class='nodeDescription'>Push XML</span>" +
        "	<button class='nodeShowHide icon-minus'></button>" +
        "	<button class='nodeDelete icon-cross'></button>" +
	    "	<div class='nodeContent'>" +
	    "		<span class='nodeTitle' contenteditable='true'>Push XML</span>" + 
	    "		<br>" + 
    ...
    initialize: function() {
        ...
        nodePanel.setupPushXmlDataPanel(connectionURL, connectionTypeURL);
